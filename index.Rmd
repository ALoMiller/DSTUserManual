...
kableExtra::kable(action.constrain.options, "html", col.names=c("Constraint Type","Name","Options","Notes"), caption = 'Constraints for Actions within the DST and the available options', escape = FALSE, booktabs =  TRUE) %>%
  kableExtra::kable_styling(font_size = 11) %>%
