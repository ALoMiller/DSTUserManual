...
```{r a.c.o, echo=FALSE, message=FALSE}
library(magrittr)
...
kableExtra::kable(action.constrain.options, "html", col.names=c("Constraint Type","Name","Options","Notes"), escape = FALSE) %>%
  kableExtra::kable_styling(font_size = 11) %>%
...
kableExtra::kable(input.options, "html", col.names=c("Variable Name","Input Format","Default Input","Notes"), escape = FALSE) %>%
  kableExtra::kable_styling(font_size = 11)
